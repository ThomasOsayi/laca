...
export default function ContactMain() {
  const channels = [
    { label: "Membership", value: "membership@thelaca.com", href: "mailto:membership@thelaca.com", icon: "email" },
    { label: "Corporate Ambassador", value: "corporateambassador@thelaca.com", href: "mailto:corporateambassador@thelaca.com", icon: "email" },
    { label: "Public Relations", value: "publicrelations@thelaca.com", href: "mailto:publicrelations@thelaca.com", icon: "email" },
    { label: "Website", value: "thelaca.com", href: "https://thelaca.com", icon: "globe" },
  ];
      ...
      <div className="container contact-main-grid">
        ...
        <div className="contact-info fade-in">
          ...
          <div className="contact-social">
            <a href="https://www.facebook.com/thelaca/" className="social-btn" aria-label="Facebook">
              <svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
            </a>
            <a href="https://www.instagram.com/thelaca/" className="social-btn" aria-label="Instagram">
            ...
            <a href="https://twitter.com/thelaca" className="social-btn" aria-label="Twitter">
              <svg viewBox="0 0 24 24" fill="currentColor"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z" /></svg>
            </a>
            <a href="https://www.youtube.com/@thelaca" className="social-btn" aria-label="YouTube">
