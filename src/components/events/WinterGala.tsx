        ...
        <div className="container">
          <div className="gala-card fade-in">
            ...
            <div className="gala-details">
              ...
              <p>
                An elegant end-of-year celebration honoring the achievements of
                our members and the partnerships that define LA hospitality. Gold
                Key Partners and General Sponsors receive complimentary admission.
              </p>
