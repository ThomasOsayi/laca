        ...
        <div className="container">
          <div className="expo-feature-grid fade-in">
            ...
            <div className="expo-feature-details">
              ...
              <p>
                Our signature annual event brings together concierges and
                hospitality professionals from across Los Angeles. For over a
                decade, this event has connected the industry&apos;s best with
                top-tier vendors and partners.
              </p>
