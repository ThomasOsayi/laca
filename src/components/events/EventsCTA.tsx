    ...
    <section className="events-cta">
      <div className="container">
        ...
        <div className="cta-buttons">
          <a href={`mailto:${emails?.publicRelations || "publicrelations@thelaca.com"}`} className="btn-primary">
            Event Inquiries <Arrow />
          </a>
          <a href={`mailto:${emails?.president || "president@thelaca.com"}`} className="btn-secondary-light">
