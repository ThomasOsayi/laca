      ...
      <div className="container mission-grid">
        <div className="mission-left fade-in">
          ...
          <div className="mission-quote">
            <p>
              &ldquo;{mission?.quote || "The Los Angeles Concierge Association will foster the education and development of its members while maintaining the highest professional and ethical standards. We will unite hotel concierges in the community encouraging service through friendship throughout the concierge profession."}&rdquo;
            </p>
