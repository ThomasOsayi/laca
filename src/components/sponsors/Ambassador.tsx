...
export default function Ambassador() {
  ...
  const ambassadorEmail = emails?.corporateAmbassador || "corporateambassador@thelaca.com";
  const membershipEmail = emails?.membership || "membership@thelaca.com";
